...
<?php 
$mynum =$_POST["num"];
$myteacherName = $_POST["teacherName"];
$myage = $_POST["age"];
...
//写SQL语句,并执行
$sql = "update teacher set teacherName='$myteacherName',age='$myage',telephone='$mytelephone',
courseName='$mycourseName',sex='$mysex',address='$myaddress' where num=$mynum ";
//echo $sql;
mysql_query($sql,$con);
//跳转到用户列表页面

...
<body>
<?php
$my_Num =  $_POST["courseNum"];
$my_cour =  $_POST["courseName"];
$my_teacher =  $_POST["teacherName"];
$my_howold =  $_POST["howold"];
$my_time =  $_POST["time"];
...
$sql = "update course set courseName='$my_cour',teacherName='$my_teacher',
howold='$my_howold',time='$my_time' where courseNum='$my_Num' ";
echo $sql;
mysql_query($sql,$con); 
//跳转到用户列表页面

...
//写SQL语句,并执行
$sql = "select * from teacher where num='$mynum' ";//num是所用表的主键
$result = mysql_query($sql,$con);
$item = mysql_fetch_array($result);
?>
<form action="teacher2.php" method="post">
<input  type="hidden" name="num" value="<?php echo $item["num"]; ?>">
教师姓名:<input readonly="readonly" type="text" name="teacherName" value="<?php echo $item["teacherName"]; ?>"><br>
年龄:<input  type="text" name="age" value="<?php echo $item["age"]; ?>"><br>
电话号码:<input  type="text" name="telephone" value="<?php echo $item["telephone"]; ?>"><br>
所教科目:<input  type="text" name="courseName" value="<?php echo $item["courseName"]; ?>"><br>
性别:<input  type="text" name="sex" value="<?php echo $item["sex"]; ?>"><br>
住址:<input  type="text" name="address" value="<?php echo $item["address"]; ?>"><br>
